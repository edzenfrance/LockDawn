...
public class CharacterSelection : MonoBehaviour
{
    ...
    + "4. Create empty GameObject in character\n"
    ...
    + "3. Character prefab must be added in Load Character Prefabs List in Stage 1-5\n"
	+ "4. If character is floating, modify the Grounded Offset and Grounded Radius in ThirdPersonController Script component\n"
